...
public class Department implements Serializable {
    ...
    public Department streetAddress(String streetAddress) {
    ...
    public Department postalCode(String postalCode) {
    ...
    public Department stateProvince(String stateProvince) {
